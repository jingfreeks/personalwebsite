    ...
    <main className="bg-page text-primary">
      <section className="relative mx-auto max-w-6xl px-5 py-24 sm:px-8">
        ...
        <div className="relative max-w-2xl">
          ...
          <Link
            href="/#contact"
            className="plain mt-8 inline-flex items-center gap-2 rounded-lg bg-accent-strong px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-accent"
          >
