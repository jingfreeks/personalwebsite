...
export default function Software() {
  return (
    <section id="software" className="mb-14">
      <h2 className="mb-1.5 text-[22px] font-bold">Software I&apos;ve Developed</h2>
      ...
      <div className="grid grid-cols-[repeat(auto-fit,minmax(220px,1fr))] gap-4">
        {softwareDeveloped.map((app) => (
          ...
          >
            <div className="relative h-[240px] w-full overflow-hidden rounded-lg bg-sidebar">
              <Image
                src={app.src}
                alt={app.title}
                fill
