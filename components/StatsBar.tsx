    ...
    <div className="relative z-10 mx-auto -mt-12 max-w-6xl px-5 sm:px-8">
      ...
      >
        {stats.map((s) => {
          ...
          return (
            <li key={s.label} className="flex items-center gap-3 rounded-xl px-3 py-4 lg:px-2 xl:px-4">
              ...
              <div className="min-w-0">
                <div className="font-heading text-xl font-bold leading-tight text-primary xl:text-2xl">{s.value}</div>
                <div className="whitespace-nowrap text-xs text-muted xl:text-sm">{s.label}</div>
